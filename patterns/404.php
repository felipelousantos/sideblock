...
return array(
	'title'      => esc_html__( '404', 'sideblock' ),
	'categories' => array( 'text' ),
	'inserter'   => false,
	'content'    => '
		<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
		<h2 class="has-text-align-center has-x-large-font-size">' . __( 'Page not found', 'sideblock' ) . '</h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph --><p>' . __( 'It looks like nothing was found at this location. Maybe try a search?', 'sideblock' ) . '</p><!-- /wp:paragraph -->
		...
		<h2 class="has-text-align-left">' . __( 'Latest posts', 'sideblock' ) . '</h2>
		<!-- /wp:heading -->
